...
const getConfigurableSettingsFromObject = (obj: any): Partial<FeatureFlags> => {
    console.log('hello', obj, configurableKeys, pick(obj, configurableKeys))
    return pick(obj, configurableKeys) as Partial<FeatureFlags>
}
...
export const setSourcegraphURL = (sourcegraphURL: string) => storage.setSync({ sourcegraphURL })
